...
/**
 * Test helper that mints RSA-signed JWTs for wallet-service integration tests.
 *
 * <p>Uses the same RSA-2048 keypair stored in {@code src/test/resources/test-keys/}.
 * The wallet-service SecurityConfig points its JWT decoder to the same public key,
