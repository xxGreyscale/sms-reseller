...
import com.smsreseller.wallet.sweep.ExpirySweepJob;
import com.smsreseller.wallet.sweep.ExpiryWarningJob;
...
class ExpiryWarningIT extends AbstractWalletIntegrationTest {
    ...
    @Autowired
    private com.smsreseller.wallet.transaction.CreditTransactionRepository transactionRepository;
    ...
    void expiryWarningJobEmitsWarningForLotDueSoon() {
        ...
        List<com.smsreseller.wallet.outbox.OutboxEntry> warnings = outboxRepository.findBySentFalse().stream()
    ...
    void expirySweepJobWritesExpireTransactionForPastLot() {
        ...
        var expireTransactions = transactionRepository.findByUserIdOrderByCreatedAtDesc(userId,
                ...
                .filter(t -> com.smsreseller.wallet.transaction.TxnType.EXPIRE.equals(t.getTxnType()))
