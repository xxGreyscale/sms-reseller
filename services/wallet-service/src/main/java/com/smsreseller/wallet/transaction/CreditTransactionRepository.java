...
import com.smsreseller.wallet.analytics.CreditUsageRow;
...
public interface CreditTransactionRepository extends JpaRepository<CreditTransaction, UUID> {
     ...
     */
    @Query("""
            SELECT new com.smsreseller.wallet.analytics.CreditUsageRow(
            ...
            WHERE t.userId = :userId
              AND t.txnType IN (
                com.smsreseller.wallet.transaction.TxnType.CONSUME,
                com.smsreseller.wallet.transaction.TxnType.EXPIRE
              )
