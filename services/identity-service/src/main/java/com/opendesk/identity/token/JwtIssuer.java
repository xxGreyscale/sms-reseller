...
/**
 * Issues RSA-signed (RS256) access JWTs for the open-desk platform.
 *
 * <p>Contract (IDEN-05 + D-02):
 * <ul>
 *   <li>Subject: user UUID as string</li>
 *   <li>Issuer: {@code https://identity.open-desk}</li>
...
public class JwtIssuer {
    ...
    static final String ISSUER = "https://identity.open-desk";
