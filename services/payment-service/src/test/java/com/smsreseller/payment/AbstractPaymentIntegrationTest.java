 ...
 *       all AMQP connection properties for the outbox relay and callback processing tests</li>
 * </ul>
 *
 ...
 * <ul>
 *   <li>{@code stub} — enables {@code StubPaymentGateway} and stub callback endpoints</li>
