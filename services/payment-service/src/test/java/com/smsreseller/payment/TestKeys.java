...
/**
 * Shared RSA-2048 test keypair loader for payment-service integration tests.
 *
 ...
 *
 * <p>Same keypair as identity-service test keys — shared-security NimbusJwtDecoder
 * validates using the public key; JwtTestHelper signs using the private key.
 */
public final class TestKeys {
    ...
    public static RSAPrivateKey loadPrivateKey() {
        try {
            ...
            throw new IllegalStateException(
                    "Failed to load test RSA private key from " + PRIVATE_KEY_RESOURCE, e);
        }
    }
    ...
    public static RSAPublicKey loadPublicKey() {
        try {
            ...
            throw new IllegalStateException(
                    "Failed to load test RSA public key from " + PUBLIC_KEY_RESOURCE, e);
        }
    }
