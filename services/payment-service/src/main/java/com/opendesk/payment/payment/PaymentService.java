...
import com.opendesk.payment.gateway.PaymentGateway;
import com.opendesk.payment.gateway.StkPushRequest;
 ...
 * <p>Implements:
 * <ul>
 *   <li>PYMT-02: Purchase initiation via {@link #initiate(UUID, PurchaseRequest)}</li>
...
public class PaymentService {
     ...
     */
    @Transactional
    public Payment initiate(UUID userId, PurchaseRequest request) {
        ...
        SmsBundle bundle = bundleRepository.findById(request.bundleId())
                .orElseThrow(() -> new IllegalArgumentException("Bundle not found: " + request.bundleId()));
