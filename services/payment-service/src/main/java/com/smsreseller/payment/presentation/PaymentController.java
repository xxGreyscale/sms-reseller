...
import com.smsreseller.payment.application.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentDto> initiate(
        ...
        Payment payment = paymentService.initiate(userId, request.bundleId(), request.msisdn(), request.provider());
