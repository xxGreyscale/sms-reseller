...
import com.opendesk.messaging.sms.SmsEncoder;
import com.opendesk.messaging.sms.SmsEncoding;
...
class SmsEncoderTest {
    ...
    void stubProviderHardFailSuffix() {
        com.opendesk.messaging.sms.StubSmsProvider stub = new com.opendesk.messaging.sms.StubSmsProvider();
        com.opendesk.messaging.sms.SmsResult result = stub.send("+2550000000001", "test", "SENDER");
        assertThat(result.outcome()).isEqualTo(com.opendesk.messaging.sms.SmsResult.Outcome.HARD_FAIL);
    }

    @Test
    void stubProviderTransientFailSuffix() {
        com.opendesk.messaging.sms.StubSmsProvider stub = new com.opendesk.messaging.sms.StubSmsProvider();
        com.opendesk.messaging.sms.SmsResult result = stub.send("+2550000000002", "test", "SENDER");
        assertThat(result.outcome()).isEqualTo(com.opendesk.messaging.sms.SmsResult.Outcome.TRANSIENT_FAIL);
    }

    @Test
    void stubProviderAcceptedByDefault() {
        com.opendesk.messaging.sms.StubSmsProvider stub = new com.opendesk.messaging.sms.StubSmsProvider();
        com.opendesk.messaging.sms.SmsResult result = stub.send("+255712345678", "test", "SENDER");
        assertThat(result.outcome()).isEqualTo(com.opendesk.messaging.sms.SmsResult.Outcome.ACCEPTED);
    }
}
