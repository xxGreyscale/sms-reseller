...
import com.opendesk.messaging.senderid.SenderIdStatus;
...
class SenderIdIT extends AbstractMessagingIntegrationTest {
    ...
    void userCanSubmitRequest() {
        ...
        Map<String, Object> body = Map.of("senderName", "OPENDESK001");
        ...
        assertThat(responseBody.get("senderName")).isEqualTo("OPENDESK001");
