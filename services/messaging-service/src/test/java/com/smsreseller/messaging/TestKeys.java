...
/**
 * Shared RSA-2048 test keypair loader for messaging-service tests.
 *
 * <p>Same keypair as wallet-service — TEST-ONLY keys committed to src/test/resources/test-keys.
 * MUST NEVER be reused in production. Production keys are injected via Kubernetes Secrets.
 */
